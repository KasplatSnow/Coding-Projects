...
public class Bishop extends Piece {
	...
	public Bishop(int x, int y, boolean color){
		...
		if(super.getColor() == false){
			try {
			    img = ImageIO.read(new File("C:\\Users\\camer\\Documents\\CS\\CS4200\\ChessAI-master\\ChessAI-master\\whitebishop.png"));
			} catch (IOException e) {
				System.out.println("file not found");
			}
		}else{
			try{
				img = ImageIO.read(new File("C:\\Users\\camer\\Documents\\CS\\CS4200\\ChessAI-master\\ChessAI-master\\blackbishop.png"));
			}catch(IOException e){
